    ...
    >
      ...
      {isLoading ? (
        ...
        <div className='mt-6 overflow-hidden rounded-[1.75rem] border border-shop-ink/10 bg-white shadow-shop-soft'>
          <div className='grid grid-cols-[minmax(0,1.3fr)_minmax(140px,0.7fr)_120px_140px] gap-4 bg-shop-blue/55 px-4 py-3 text-xs font-bold uppercase tracking-wide text-shop-ink/60'>
            <span>Sản phẩm</span>
            <span>Danh mục</span>
            <span>Tồn kho</span>
            <span>Giá</span>
          ...
          <div className='divide-y divide-shop-ink/8'>
            {products.map((product) => (
              <div
                key={product.id}
                className='grid grid-cols-[minmax(0,1.3fr)_minmax(140px,0.7fr)_120px_140px] gap-4 px-4 py-4 text-sm'
              >
